$(()=>{setTimeout(()=>{
  ...
  $.getJSON( "/c/sa/user/profile/"+window.accountUserId, (userdata) => {
    ...
    $.each(window.gcAccountUserMenu.items, (i, el) => {
      ...
      const link = el.subitems.length == 0 || el.subitems.length > 1 ? 'javascript:void(0)' : el.subitems[0]?.url;
...
var iconsList = {
  ...
  `,
  cms: `<svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  teach: `<svg width="34" height="29" viewBox="0 0 34 29" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  user: `<svg width="34" height="30" viewBox="0 0 34 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  tasks: `<svg width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  notifications: `<svg width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  sales: `<svg width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  chatium: `<svg width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
